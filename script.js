...
form.addEventListener("submit", (e) => {
  ...
  const fieldLabels = {
    ...
    outroTipoVeiculo: "✏️ *Especifique Tipo de Veículo*",
    preferenciaVeiculo: "🔍 *Preferência de Veículo*",
    investimento: "💰 *Faixa de Investimento*",
    pagamento: "💳 *Forma de Pagamento*",
    tempoCompra: "⏳ *Previsão de Compra*",
    financiamento: "🏦 *Status do Financiamento*",
    conheceuLoja: "📢 *Como Conheceu a Loja*",
    outroConheceuLoja: "✏️ *Especifique Como Conheceu*",
    indicacao: "👤 *Indicação*",
